...
export const PROJECTS = [
  ...
  // ── 개인 프로젝트 ──
  {
    ...
    goal: '아이의 첫 경제활동을 어떻게 도와주어야 할까?',
    result: 'Vite + React + Tailwind 모바일 우선 프로토타입 구현 · 시나리오·화면 흐름 완성',
    rows: [
      { label: '프로젝트명', value: '어린이 경제 마법사 학교' },
      { label: '주요목표', value: '아이의 첫 경제활동을 어떻게 도와주어야 할까?' },
      {
        label: '개요',
        value: '만 7~9세 아이의 첫 용돈·첫 소비를 위한 어린이 경제 교육 앱. 마법사 세계관과 마음 친구 도감으로 아이가 올바른 경제 습관을 만들어간다.',
      },
      {
        label: '핵심기여',
  ...
  },
  {
    ...
    subtitle: '온·오프라인 융합 미래형 학습 경험',
    goal: '놀이처럼 몰입하고, 프로젝트로 완성되는 배움 — 온·오프라인을 잇는 미래형 학습 경험',
    result: '컨셉 기획 · 시나리오 설계 · 시연 영상 제작 (유튜브 공개)',
    rows: [
      { label: '프로젝트명', value: 'THE EARTH PROJECT' },
      { label: '주요목표', value: '놀이처럼 몰입하고, 프로젝트로 완성되는 배움 — 온·오프라인을 잇는 미래형 학습 경험' },
      {
        label: '개요',
        value: '메타버스에서 탐험하고 현실에서 실천하는 온·오프라인 융합 교육 프로젝트. 게이미피케이션으로 몰입을 이끌고, 협력과 창의로 전인적 성장을 완성하는 미래형 학습 경험을 제공.',
      },
      { label: '핵심기여', value: '컨셉 기획·시나리오 설계·시연 영상 제작' },
    ],
    tags: ['교육 콘텐츠 기획', '메타버스', '게이미피케이션', 'ESG'],
